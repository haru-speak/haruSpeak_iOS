...
//MARK: - LifeCycle
    override func viewDidLoad() {
        ...
        attributedStr.addAttribute(.foregroundColor, value: UIColor.mainColor, range: (titleLabel.text! as NSString).range(of: "한국어"))
        titleLabel.attributedText = attributedStr
        
        self.progressBar.ratio = 2/5
    }
//MARK: - AddSubview
    func setUpView(){
